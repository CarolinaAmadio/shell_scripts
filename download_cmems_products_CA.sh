...
declare DOWNLOAD_DIR="/g100_scratch/userexternal/camadio0/GL_CMEMS/CMEMS_013_035_GL_DATA";
declare FTP_BASE_PATH="/Core/INSITU_MED_PHYBGCWAV_DISCRETE_MYNRT_013_035/cmems_obs-ins_med_phybgcwav_mynrt_na_irr/monthly/GL";
...
do
	...
	do
		...
		FTP_URL="ftp://${SITE}${FTP_BASE_PATH}/${YEAR}${MONTH}/";
                #echo $FTP_URL
		# list files
		curl \
			--silent \
